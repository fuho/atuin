    ...
    async fn run_inner(
        ...
        match self {
            ...
            Self::Sync(_) if settings.offline => {
                bail!("Cannot sync in offline mode. Use --online or set offline=false in config.toml");
            }
            ...
            Self::Account(_) if settings.offline => {
                bail!("Cannot access account in offline mode. Use --online or set offline=false in config.toml");
            }
            ...
            Self::Ai(_) if settings.offline => {
                bail!("Cannot use AI in offline mode. Use --online or set offline=false in config.toml");
            }
